...
const ADDRESS_WITH_ETH_1:felt252 = 0x0416575467BBE3E3D1ABC92d175c71e06C7EA1FaB37120983A08b6a2B2D12794;
const ADDRESS_WITH_ETH_2:felt252 = 0x0092fB909857ba418627B9e40A7863F75768A0ea80D306Fb5757eEA7DdbBd4Fc;
...
fn get_random_number_with_vrf() {
    ...
    start_cheat_caller_address(eth_dispatcher.contract_address, contract_address_const::<ADDRESS_WITH_ETH_2>());
    eth_dispatcher
        .transfer(
